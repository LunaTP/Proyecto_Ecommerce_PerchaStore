	...
	<div class="center-table ">
		...
		<input type=hidden name=op value=1 />
			<table class="table table-striped table-bordered">		
					...
					<tr>
						<td>Categoria</td>
						<td><input name=txtcat value='<%=ObjC.getIdCategoria() %>' /></td>
					</tr>
					<tr>
						<td>Nombres</td>
						<td><input name=txtnom value=<%=ObjC.getDescripcion() %> /></td>
					</tr>
					<tr>
						<td>Precio</td>
						<td><input name=txtpre value=<%=ObjC.getPrecioUnidad() %> /></td>
					</tr>
					<tr>
						<td>Stock</td>
						<td><input name=txtsto value=<%=ObjC.getStock() %> /></td>
					</tr>
					<tr>
